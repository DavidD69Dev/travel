    ...
    <div style={{
        ...
        <Navbar />
            <div className='max-w-6xl mx-auto flex gap-10 md:gap-0 flex-col md:flex-row items-center justify-center px-6 mt-7'>
                {/* text section */}
                <div className='md:space-y-7 space-y-4 lg:w-[630px] lg:[535px]'>
                    <h3 className='font-bold text-[#DF6951] text-sm'>BEST DESTINATIONS AROUND THE WORLD</h3>
                    <div>
                        <h1 className='lg:text-7xl text-5xl text-[#181E4B] font-bold lg:w-[545px] volkhov-bold z-50'>Travel, enjoy and live a new and full life</h1>
