    ...
    <div>
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
        <div className="space-y-6 lg:w-[800px] px-6 md:px-0">
          <h3 className="poppins-medium text-[#5E6282] text-sm">
            Easy and Fast
          </h3>
          <h1 className="volkhov-bold text-[#14183E] text-3xl md:text-5xl capitalize">
          ...
          <div className="space-y-9 lg:w-[395px] lg:h-[289px]">
            <div className="flex gap-3 items-center">
              ...
              <div>
                <h3 className="text-[#5E6282] poppins-bold">
                  Choose Destination
                </h3>
