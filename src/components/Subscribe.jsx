...
const Subscribe = () => {
  return (
    <div className="mt-20 mb-20 px-4">
      <div
        className="rounded-2xl max-w-6xl mx-auto py-20 lg:px-48 px-12 relative"
        style={{
      ...
      >
        ...
        <img src={mask1}alt="" className="absolute bottom-0 left-10 opacity-20 -z-10 hidden md:block" />
